...
content model"): typed structure with traceability as fields, never freestyle
document text. Serialized JSON per package version.
...
class CvExperienceEntry:
    ...
    limited to the confirmed row's own columns."""
